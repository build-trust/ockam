  ...
  describe "Ockam.Identity.import/2" do
    test "existing identity can be imported and used" do
      ...
      assert identifier == @expected_identifier
       ...
       {:ok, attestation} = Identity.attest_purpose_key(identity, pub_key)
       {:ok, true} = Identity.verify_purpose_key_attestation(identity, pub_key, attestation)
    end
