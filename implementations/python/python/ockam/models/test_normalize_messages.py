...
# from ockam.nodes.message import UserMessage, AssistantMessage, SystemMessage, ToolCallResponseMessage
...
#     messages = [UserMessage(""), AssistantMessage("hi")]
#     result = normalize_messages(
#         messages, is_thinking=False, tools_supported=True, forced_assistant_answer_supported=True
#     )
...
#     messages = [
#         SystemMessage(),  # no content
#         UserMessage(),  # no content
#         AssistantMessage(),  # no content/tool_calls
#         AssistantMessage(),  # no content/tool_calls
#         ToolCallResponseMessage(),  # no name
#         ToolCallResponseMessage(name="toolname"),  # valid
#         UserMessage("hi"),  # valid
#         AssistantMessage("ok"),  # valid
#         AssistantMessage(tool_calls=[1]),  # valid
#     ]
#     result = normalize_messages(
#         messages, is_thinking=False, tools_supported=True, forced_assistant_answer_supported=True
#     )
...
#     messages = [
#         AssistantMessage("foo", tool_calls=[1]),
#         AssistantMessage(tool_calls=[2]),
#         AssistantMessage("foo"),
#     ]
#     result = normalize_messages(
#         messages, is_thinking=False, tools_supported=True, forced_assistant_answer_supported=True
#     )
...
#     messages = [
#         UserMessage("hi", scope="abc"),
#         AssistantMessage(conversation="xyz"),
#         UserMessage("hi", scope="abc", conversation="xyz"),
#     ]
#     result = normalize_messages(
#         messages, is_thinking=False, tools_supported=True, forced_assistant_answer_supported=True
#     )
...
#     messages = [
#         ToolCallResponseMessage("toolname"),
...
#         UserMessage("world"),
#         AssistantMessage("hi"),
#         AssistantMessage("there"),
#         UserMessage("again", foo=1),
#         UserMessage("bar", foo=1),
#         UserMessage("baz", foo=2),
#     ]
#     result = normalize_messages(
#         messages, is_thinking=False, tools_supported=True, forced_assistant_answer_supported=True
#     )
...
#     messages = [
#         AssistantMessage("Create me a new recipe for a cake."),
#         AssistantMessage("First we need to gather ingredients, such as"),
#     ]
#     result = normalize_messages(
#         messages, is_thinking=False, tools_supported=True, forced_assistant_answer_supported=True
#     )
