        ...
        if hasattr(choice, "delta"):
            ...
            if choice.finish_reason is not None:
                ...
                if hasattr(delta, "reasoning_content") and delta.reasoning_content:
                    response = {"role": role, "content": {"type": "text", "text": delta.reasoning_content}, "thinking": True}
            ...
            if hasattr(message, "reasoning_content") and message.reasoning_content:
                yield (
                    ...
                    self.converter.conversation_message_from_dict(
                        {"role": message.role, "content": {"type": "text", "text": message.reasoning_content}, "thinking": True}
                    ),
                )
