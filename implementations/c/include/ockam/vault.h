...
#define OCKAM_VAULT_P256_PUBLICKEY_LENGTH       33u

#define OCKAM_VAULT_ERROR_INVALID_PARAM             (OCKAM_ERROR_INTERFACE_VAULT | 1u)
#define OCKAM_VAULT_ERROR_INVALID_ATTRIBUTES        (OCKAM_ERROR_INTERFACE_VAULT | 2u)
#define OCKAM_VAULT_ERROR_INVALID_CONTEXT           (OCKAM_ERROR_INTERFACE_VAULT | 3u)
#define OCKAM_VAULT_ERROR_INVALID_BUFFER            (OCKAM_ERROR_INTERFACE_VAULT | 4u)
#define OCKAM_VAULT_ERROR_INVALID_SIZE              (OCKAM_ERROR_INTERFACE_VAULT | 5u)
#define OCKAM_VAULT_ERROR_BUFFER_TOO_SMALL          (OCKAM_ERROR_INTERFACE_VAULT | 6u)
#define OCKAM_VAULT_ERROR_INVALID_REGENERATE        (OCKAM_ERROR_INTERFACE_VAULT | 7u)
#define OCKAM_VAULT_ERROR_INVALID_SECRET_ATTRIBUTES (OCKAM_ERROR_INTERFACE_VAULT | 8u)
#define OCKAM_VAULT_ERROR_INVALID_SECRET_TYPE       (OCKAM_ERROR_INTERFACE_VAULT | 9u)
#define OCKAM_VAULT_ERROR_INVALID_TAG               (OCKAM_ERROR_INTERFACE_VAULT | 10u)
#define OCKAM_VAULT_ERROR_PUBLIC_KEY_FAIL           (OCKAM_ERROR_INTERFACE_VAULT | 11u)
#define OCKAM_VAULT_ERROR_ECDH_FAIL                 (OCKAM_ERROR_INTERFACE_VAULT | 12u)
#define OCKAM_VAULT_ERROR_DEFAULT_RANDOM_REQUIRED   (OCKAM_ERROR_INTERFACE_VAULT | 13u)
#define OCKAM_VAULT_ERROR_MEMORY_REQUIRED           (OCKAM_ERROR_INTERFACE_VAULT | 14u)
#define OCKAM_VAULT_ERROR_SECRET_SIZE_MISMATCH      (OCKAM_ERROR_INTERFACE_VAULT | 15u)
#define OCKAM_VAULT_ERROR_KEYGEN_FAIL               (OCKAM_ERROR_INTERFACE_VAULT | 16u)
