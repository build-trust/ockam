...
#define VAULT_ERROR_INVALID_REGENERATE        (OCKAM_ERROR_INTERFACE_VAULT | 7u)
#define VAULT_ERROR_INVALID_SECRET_ATTRIBUTES (OCKAM_ERROR_INTERFACE_VAULT | 8u)
#define VAULT_ERROR_INVALID_SECRET_TYPE       (OCKAM_ERROR_INTERFACE_VAULT | 9u)
#define VAULT_ERROR_INVALID_TAG               (OCKAM_ERROR_INTERFACE_VAULT | 10u)
#define VAULT_ERROR_PUBLIC_KEY_FAIL           (OCKAM_ERROR_INTERFACE_VAULT | 11u)
#define VAULT_ERROR_ECDH_FAIL                 (OCKAM_ERROR_INTERFACE_VAULT | 12u)
#define VAULT_ERROR_DEFAULT_RANDOM_REQUIRED   (OCKAM_ERROR_INTERFACE_VAULT | 13u)
#define VAULT_ERROR_MEMORY_REQUIRED           (OCKAM_ERROR_INTERFACE_VAULT | 14u)
#define VAULT_ERROR_SECRET_SIZE_MISMATCH      (OCKAM_ERROR_INTERFACE_VAULT | 15u)
#define VAULT_ERROR_KEYGEN_FAIL               (OCKAM_ERROR_INTERFACE_VAULT | 16u)
