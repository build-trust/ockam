...
## TODO: it's ok to be broken.  node create blue make node not know anything about projects,  no trust context, so
##       can't resolve /project/default  (won't know how to present credential neither)
