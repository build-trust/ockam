...
@test "project enrollment" {
  ...
  run $OCKAM project authenticate --identity green --project /tmp/project.json
  assert_failure
  ...
  run $OCKAM project authenticate --identity blue --token $blue_token --project /tmp/project.json
  assert_success
