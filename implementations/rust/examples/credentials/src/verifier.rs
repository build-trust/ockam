...
use ockam::{CredentialPresentation, CredentialVerifier, PresentationManifest};
use std::{
    convert::TryFrom,
...
fn main() {
    ...
    loop {
        let presentations = listen_for_presentation();
...
fn listen_for_presentation() -> Vec<CredentialPresentation> {
    unimplemented!();
}
