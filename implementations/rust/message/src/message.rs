...
mod tests {
    ...
    fn route_codec() {
        ...
        assert_eq!(
            v,
            vec![
                3, 2, 0, 127, 0, 0, 1, 0x80, 0x80, 2, 0, 10, 0, 1, 10, 0x70, 0x70, 0, 4, 0, 1, 2, 3
            ]
        );
    ...
    fn message_codec() {
        ...
        onward_route.addresses.push(Address::UdpAddress(
            IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)),
            0x8080,
        ));
        onward_route.addresses.push(Address::UdpAddress(
        ...
        return_route.addresses.push(Address::UdpAddress(
