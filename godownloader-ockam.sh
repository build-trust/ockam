#!/bin/sh
set -e
# Code generated by godownloader on 2019-01-10T01:39:59Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for ockam-network/ockam

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/ockam-network/ockam/releases
