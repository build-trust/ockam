...
#
# This hands-on example uses Ockam to create an end-to-end encrypted portal to mongodb. We
# connect a nodejs app in one private kubernetes cluster with a mongodb database in another
