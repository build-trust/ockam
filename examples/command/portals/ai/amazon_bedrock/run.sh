...
#
# This hands-on example uses Ockam to create an end-to-end encrypted portal to an AI API. We connect a nodejs API
# Client in one Amazon VPC with a nodejs AI API Server in another Amazon VPC.
#
