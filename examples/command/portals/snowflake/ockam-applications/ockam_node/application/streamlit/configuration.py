...
def configure_tcp_inlet_or_outlet(type):
    ...
    """)
    relay = st.text_input("Via", placeholder="postgres", label_visibility="collapsed")
    ...
    """)
    allowed = st.text_input("Allow", placeholder="postgres-server" if type == "inlet" else "postgres-client",
                            label_visibility="collapsed")
