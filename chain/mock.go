...
func (n mockNode) FetchClaim(key string) ([]byte, ockam.Claim, error)   { return nil, nil, nil }
func (n mockNode) FetchEntity(key string) ([]byte, ockam.Entity, error) { return nil, nil, nil }
